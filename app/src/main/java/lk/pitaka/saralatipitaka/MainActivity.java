package lk.pitaka.saralatipitaka;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebViewClient client = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                try {
                    ...
                    if (!givenUrl.toString().contains("intro.html") && !givenUrl.toString().contains("index.html")) {
                        Intent intent = new Intent(Intent.ACTION_VIEW, android.net.Uri.parse(url));
                        startActivity(intent);
                        return true;
                    }
                } catch (java.net.MalformedURLException e) {}
                return false; // open index/intro links in the webview itself
            }
        };
        ...
        String webviewLoadUrl = "file:///android_asset/main/index.html";
        String appLinkQuery = "";
